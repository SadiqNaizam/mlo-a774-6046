...
type AppView = 'splash' | 'features' | 'dashboard' | 'payment' | 'payment-status' | 'settings';
...
const IndexPage: React.FC = () => {
  ...
  const handleGoBackToDashboard = useCallback(() => setView('dashboard'), []);
  ...
  const renderCurrentView = () => {
    switch (view) {
      ...
      case 'payment':
        return (
          <MainAppLayout
            ...
            showBackButton={true}
            onBackClick={handleGoBackToDashboard}
          >
      ...
      case 'payment-status':
        return (
          <MainAppLayout headerTitle="Transaction Status">
            <div className="flex h-full flex-col">
                <div className="flex-grow overflow-y-auto">
                    <TransactionStatus />
                </div>
  ...
  return (
    ...
    <div className="flex min-h-screen w-full items-center justify-center bg-red-950 p-4 font-sans">
